...
- 前置依赖：建议先理解 第 30 章：AI 网络基础 中的核心对象和路径。
...
![图：31.2.2 系统架构](../assets/diagrams/part-07-network-storage-chapter-31-scale-up-networking-01.svg)
...
![图：31.3.3 NVSwitch](../assets/diagrams/part-07-network-storage-chapter-31-scale-up-networking-02.svg)
...
![图：31.3.8 GB200 / NVL72 类架构](../assets/diagrams/part-07-network-storage-chapter-31-scale-up-networking-03.svg)
