...
![图：0.2.2 系统架构](../assets/diagrams/part-00-introduction-chapter-00-from-datacenter-to-ai-factory-01.svg)
...
![图：0.3.6 一次推理请求的完整路径](../assets/diagrams/part-00-introduction-chapter-00-from-datacenter-to-ai-factory-02.svg)
...
![图：0.3.7 一次训练任务的完整路径](../assets/diagrams/part-00-introduction-chapter-00-from-datacenter-to-ai-factory-03.svg)


### 0.3.8 为什么 AI Factory 是系统工程
