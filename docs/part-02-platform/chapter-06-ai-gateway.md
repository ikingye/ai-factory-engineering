...
- 前置依赖：建议先理解 第 5 章：MaaS 平台 中的核心对象和路径。
- 后续关联：本章内容会继续连接到 第 7 章：计量与计费，并在系统地图、深度标准和读者测试中被交叉引用。
- 读完能力：读完本章后，读者应能把《AI Gateway》中的概念映射到 AI Factory 的生产路径、工程对象、观测证据和设计取舍。


### 6.1.3 读者测试

- 机制题：读者能否解释 为什么需要 AI Gateway、认证鉴权、流量治理、模型路由 的核心机制，以及它们如何共同支撑《AI Gateway》？
...
- 排障题：当《AI Gateway》相关生产症状出现时，读者能否列出第一层证据、下一跳证据、可能 owner 和止血动作？
...
### 6.3.8 Envoy AI Gateway 与 Gateway API Inference Extension
