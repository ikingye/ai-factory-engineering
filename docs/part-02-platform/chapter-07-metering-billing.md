...
- 前置依赖：建议先理解 第 6 章：AI Gateway 中的核心对象和路径。
...
![图：7.3.1 token 计量](../assets/diagrams/part-02-platform-chapter-07-metering-billing-02.svg)
...
![图：7.3.8 毛利模型](../assets/diagrams/part-02-platform-chapter-07-metering-billing-03.svg)
