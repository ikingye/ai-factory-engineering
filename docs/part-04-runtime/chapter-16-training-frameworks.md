...
- 前置依赖：建议先理解 第 15 章：推理引擎 中的核心对象和路径。
...
![图：16.3.2 DeepSpeed](../assets/diagrams/part-04-runtime-chapter-16-training-frameworks-02.svg)
...
![图：16.3.8 activation checkpointing](../assets/diagrams/part-04-runtime-chapter-16-training-frameworks-03.svg)
