...
| --- | --- | --- | --- | --- |
| 低功耗通用推理/视频 | NVIDIA L4 | Ada Lovelace；24GB GDDR6；300GB/s；72W；PCIe Gen4 x16 64GB/s | 视频推理、轻量 LLM 推理、边缘/通用服务器加速 | 单槽低功耗，适合密度和能效；不适合大模型训练或强通信任务。 |
...
| Hopper 主力池 | NVIDIA H100 SXM | Hopper；80GB HBM3；3.35TB/s；FP8 Transformer Engine；NVLink 900GB/s；PCIe Gen5 128GB/s；最高 700W configurable | 大规模训练、高性能推理、HPC+AI | 生态成熟，适合作为 2026 生产基线；仍要区分 SXM、NVL、PCIe 等形态。 |
