...
- 前置依赖：建议先理解 第 35 章：GPU 芯片与系统架构 中的核心对象和路径。
...
![图：36.2.2 系统架构](../assets/diagrams/part-08-physical-infrastructure-chapter-36-ai-datacenter-engineering-01.svg)

物理产能激活可以进一步表示为状态机：

![图：36.2.2 系统架构](../assets/diagrams/part-08-physical-infrastructure-chapter-36-ai-datacenter-engineering-02.svg)
...
![图：36.4.1 工程实现](../assets/diagrams/part-08-physical-infrastructure-chapter-36-ai-datacenter-engineering-03.svg)
